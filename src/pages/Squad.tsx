    ...
    <div className="min-h-screen bg-slate-50 py-8">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-slate-600 px-4">Meet our talented players who make Cogni Hfx FC special really very special</p>
        </div>

        {/* Squad Statistics */}
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-xl shadow-lg p-4 md:p-8">
            <h2 className="text-xl md:text-2xl font-bold text-center text-slate-900 mb-4 md:mb-6">Squad Statistics</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center">
              <div>
                ...
                <div className="text-xl md:text-2xl font-bold text-slate-900 mb-1">{players.length}</div>
                <div className="text-xs md:text-base text-slate-600">Total Players</div>
              </div>
              <div>
                ...
                <div className="text-xs md:text-base text-slate-600">Goals Scored</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-xl md:text-2xl font-bold text-slate-900 mb-1">
                  {Math.round(players.reduce((total, player) => total + player.age, 0) / players.length)}
                </div>
                <div className="text-xs md:text-base text-slate-600">Average Age</div>
              </div>
            </div>
          </div>
        </div>
            ...
            return (
              <div key={position} className="max-w-6xl mx-auto">
                <div className="flex items-center justify-center mb-8">
                  <h2 className="text-xl md:text-2xl font-bold text-slate-900 mr-4">{position}s</h2>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${getPositionColor(position)}`}>
                    ...
                    >
                      <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 overflow-hidden">
                        ...
                        <div className="p-4 md:p-6">
                          <h3 className="text-base md:text-lg font-bold text-slate-900 mb-1">{player.name}</h3>
                          ...
                          <div className="grid grid-cols-3 gap-2 md:gap-4 text-center text-xs md:text-sm">
                            ...
                            <div>
                              <div className="font-bold text-slate-900">{player.appearances}</div>
