...
const Gallery: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updated = await fetch('/.netlify/functions/getGallery').then(r => r.json());
    ...
    <div className="min-h-screen bg-slate-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-600">Capturing our best moments on and off the pitch</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6">
            {filteredImages.map((image, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-xl bg-white shadow hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  <img
                    src={image.image_url}
                    alt={image.caption}
